...
Site.create!(location: "texas", start_date: Date.current(), completed: true)
Site.create!(location: "florida", start_date: Date.current(), completed: true)
Site.create!(location: "colorado", start_date: Date.current(), completed: true)
